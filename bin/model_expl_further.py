...
filepath = '../data/weights/atc'+cv_version+'_v2_best_lr1_again.hk'
...
vgg.model.fit_generator(traingen, samples_per_epoch=traingen.nb_sample, nb_epoch=60,
...
filepath = '../data/weights/atc'+cv_version+'_v2_best_lr2_again.hk'
saver = ModelCheckpoint(filepath, verbose=1, save_best_only=True, save_weights_only=True)
...
filepath = '../data/weights/atc'+cv_version+'_v2_best_lr3_again.hk'
saver = ModelCheckpoint(filepath, verbose=1, save_best_only=True, save_weights_only=True)
